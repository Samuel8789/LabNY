# -*- coding: utf-8 -*-
"""
Created on Wed Apr 21 14:50:09 2021
...
def main():
    ...
    f_dir = '\\\?\\'+r'C:\Users\sp3660\Documents\Projects\LabNY\Working_Mice_Data\Mice_Projects\Interneuron_Optogenetics\G2C\SPGV\imaging\20210413\data aquisitions\FOV_1\SPGV_FOV1_2mintestt_WL940_WideFilter-000\planes\Plane1\Green'
    ...
    f_name = 'SPGV_FOV1_2mintestt_WL940_WideFilter-000_d1_256_d2_256_d3_1_order_F_frames_3391_.mmap';
    fnames = os.path.join(f_dir,f_name)
    
    # %%   Set up some parameters
    
    fr = 28  # frame rate (Hz) 3pl + 4ms = 15.5455
    ...
    init_batch = 2000  # number of frames for initialization (presumably from the first file)
    ...
    Cn = images.local_correlations( frames_per_chunk=300)
    ...
    cnm.estimates.Cn = Cn
    cnm.save(os.path.splitext(fnames)[0]+'_'+str(gSig[0])+'gsig_results.hdf5')
