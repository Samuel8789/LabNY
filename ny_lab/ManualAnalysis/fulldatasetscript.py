...
tosavedir=r'C:\Users\sp3660\Desktop\TemporaryProcessing\FullSyncTest'
if not os.path.isdir(tosavedir):
    os.mkdir(tosavedir)
prairireseqdir=r'F:\Projects\LabNY\Imaging\2022\20221221\Calibrations\SensoryStimulation\TestAcquisitions\221221_Test_Card_10CellOptoScreen_25x_940_51020_60745-000\Ch2Green\plane1'
...
if initial:
    ...
    f,ax=plt.subplots(1)
    ax.plot(scored)
    ax.plot(led_frame_start_end+pad1, scored[led_frame_start_end+pad1],'ro')
    ax.plot(led_frame_end_start-pad2, scored[led_frame_end_start-pad2],'ro')
    ax.plot(led_frame_start_end, scored[led_frame_start_end],'bo')
    ax.plot(led_frame_end_start, scored[led_frame_end_start],'bo')
...
#%%
temporary_path1=r'F:\Projects\LabNY\Imaging\2022\20221221\Calibrations\SensoryStimulation\TestAcquisitions\221221_Test_Card_10CellOptoScreen_25x_940_51020_60745-000'
