...
% ------ Moving Gratings ------
ops.driftingGrating = 0;                                    % use if you want to make it drifting grating
...
for designstim=1
    ...
    for cc=ops.ctrst %contrast (out of 7)
        ...
        for s=ops.spfrq %determine spatial frequency
            ...
            sp1=(.5799/10.2)*ops.spfrqs(1); %10.2 is just some scaling factor that i calibrated. do not change unless you know what youre doing!
