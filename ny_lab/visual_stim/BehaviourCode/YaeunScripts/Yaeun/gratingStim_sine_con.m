function gratingStim_sine_con(tempfreq,spfreq,sduration,iduration,nsessions)

%gratingStim_sine_con(2,0.05,100,30,1)
...
angle_opt = [0 45 90 135 180 225 270 315];
rand_angle = randperm(8);
angles = angle_opt(rand_angle(1:5));
...
Screen('Flip', win);
tic
while (toc<=600) % wait 50 seconds for the screen to adjust
    tim = toc;
