# -*- coding: utf-8 -*-
"""
Created on Fri May 21 08:11:17 2021
...
oriSPJOday1=dgc_dire_list[random.randint(0,len(dgc_dire_list)-1)]
oriSPJPday1=dgc_dire_list[random.randint(0,len(dgc_dire_list)-1)]
dgc_dire_listSPJOday1=np.array([oriSPJOday1,])
dgc_dire_listSPJPday1=np.array([oriSPJPday1,])
...
dgc_is_blank_block = False
dgc_is_random_start_phase = False
# =================================================================================
# ======================= Drifting Grating Circle =================================
dgcSPJO = stim.DriftingGratingCircle(monitor=mon, indicator=ind, pregap_dur=pregap_dur,
                                 ...
                                 dire_list=dgc_dire_listSPJOday1, con_list=dgc_con_list,
...
dgcSPJP = stim.DriftingGratingCircle(monitor=mon, indicator=ind, pregap_dur=pregap_dur,
                                 postgap_dur=postgap_dur, coordinate=coordinate,
                                 background=background, center=dgc_center,
                                 sf_list=dgc_sf_list, tf_list=dgc_tf_list,
                                 dire_list=dgc_dire_listSPJPday1, con_list=dgc_con_list,
                                 radius_list=dgc_radius_list, block_dur=dgc_block_dur,
                                 midgap_dur=dgc_midgap_dur, iteration=dgc_iteration,
                                 is_smooth_edge=dgc_is_smooth_edge,
                                 smooth_width_ratio=dgc_smooth_width_ratio,
...
# ======================= Tuning Drifting Grating Circle =================================
dgc2 = stim.DriftingGratingCircle(monitor=mon, indicator=ind, pregap_dur=pregap_dur,
                                 postgap_dur=postgap_dur, coordinate=coordinate,
                                 background=background, center=dgc_center,
                                 sf_list=dgc_sf_list, tf_list=dgc_tf_list,
                                 dire_list=dgc_dire_list, con_list=dgc_con_list,
                                 radius_list=dgc_radius_list, block_dur=dgc2_block_dur,
                                 midgap_dur=dgc2_midgap_dur, iteration=dgc2_iteration,
                                 is_smooth_edge=dgc_is_smooth_edge,
                                 smooth_width_ratio=dgc_smooth_width_ratio,
                                 smooth_func=dgc_smooth_func, is_blank_block=dgc_is_blank_block,
                                 is_random_start_phase=dgc_is_random_start_phase)
...
cs_stim_ind_sequence = [0, 1, 2]
all_stim = [uc, dgcSPJO, dgc2]
