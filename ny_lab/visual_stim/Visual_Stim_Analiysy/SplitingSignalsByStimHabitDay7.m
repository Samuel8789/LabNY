%video1
%SPHB_Habituation_Day6_500filter_940_3planes-000_plane1_Full_GCaMP_5gsig_results_sort
...
%%
raster_matrix_spont=zeros(6,4834);
raster_matrix_trials=zeros(6,5514);
