function [vecTex] = buildGratingPie2(Par,ptrWindow,dblRotAngle,contrast,intThisTrial)
...
for intFrame = 1:Par.intFrameRate
    vecTex(intFrame) = Screen('MakeTexture', ptrWindow, fullstimgrat(:,:,intFrame), optimizeForDrawAngle, 1);
end
