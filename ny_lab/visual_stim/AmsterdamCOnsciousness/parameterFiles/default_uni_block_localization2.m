function Par = default_uni_block_localization
...
Par.dblSigma                    = 50; %standard deviation of gaussian window
...
Par.dblSecsPreStim              = [0.1 0.1]; %length of timewindow before stim onset (one of these two is randomly selected)
Par.boolAbortTrial              = false; %whether to abort the trial if the animal licks in the pre-stim period
Par.dblSecsStartResp            = 0; %start of response window after stim onset
