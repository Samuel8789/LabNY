...
Par.dblGratingContrast          = [0.15 0.3 0.6];    %0-1
...
Par.PostDur                     = 0;        % Post-stimulus epoch duration in senconds. 
...
Par.TactileTrialsFreq           = 0; %frequency of tactile trials / unimodal trials.
