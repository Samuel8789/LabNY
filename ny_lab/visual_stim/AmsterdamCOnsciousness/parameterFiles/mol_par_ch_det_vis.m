function Par = mol_par_ch_det_vis(varargin)
...
Par.vecCenterFreq               = [8000]; %Center frequency with octaves below and above as well
Par.ShepardTones                = 9;
...
Par.intFirstBlock               = 1;        %Visual first block so visual trials only (0=auditory)
...
Stage.vecOriChange              = {120      90      90          [15 45 90]  [1 2 5 15 45 90]  }; 
