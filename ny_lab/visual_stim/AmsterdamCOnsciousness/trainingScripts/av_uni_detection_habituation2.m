function av_uni_detection_habituation(Par,Objects,sessionData)
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            case 'StimDuring' %State: keep presenting stimuli and detect response
                ...
                if ~boolGaveReward && toc(refTime) > Par.dblSecsPreReward - vecTrial.StimStart(intThisTrial) 
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            case 'RewardConsumption' %State: time window for reward consumption
                ...
                if toc(refTime) - vecTrial.lickTime{intThisTrial}(end) > Par.RewardConsumptionSecs; 
                    state = 'EndTrial';
                end             
