...
class RunNYLab(Project):    
    def __init__(self,  githubtoken_path, gui=False ):
        ...
        if Project.computer=='DESKTOP-ETJV9PS' or 'YUSTELABMSIPC01':
    ...
    def load_datbaseSaved_paths_roots(self):
        ...
        if Project.computer=='YUSTELABMSIPC01':
            query_get_paths="""
                        SELECT *
            ...
            query_get_paths="""
                        ...
                        """                
        elif Project.computer=='DESKTOP-ETJV9PS':
            query_get_paths="""
                        SELECT *
                        FROM SavedPathsNewPC_table
                        """               
